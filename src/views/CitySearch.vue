...
export default {
  ...
  created() {
    // Using this.$ls.get() calls on the localstorage to set our city and save it if refreshed
  ...
  methods: {
    saveCity: function(city) {
      // this.favorites array will let save our selected city from the list
    ...
    getCities: function() {
      ...
      if (this.$ls.get(cacheLabel)) {
        ...
        //below sets it to cache the data and reports in the console log
          .then(response => {
